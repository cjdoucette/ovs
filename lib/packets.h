...
void packet_set_xia(struct dp_packet *, uint8_t version, uint8_t next_hdr, ovs_be16 payload_len, uint8_t hop_limit, uint8_t num_dst, uint8_t num_src, uint8_t last_node);
